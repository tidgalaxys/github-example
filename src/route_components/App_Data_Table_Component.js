...
/*
  ...
  */
  ...
  const columns = [
    ...
    {
      name: "Actions",            
      cell:(row)=><button onClick={clickHandler} id={row.title}>Action</button>,
      ignoreRowClick: true,
      allowOverflow: true,
      button: true,
    }
...
const data2 = [
  ...
  const [searchcolumns,setsearchcolumns] = useState(["title","year"]);
  ...
  return (
    <div>
       ...
       <DataTable
        ...
        <button onClick={(e) => handleclicktest(e,'tid')}>clicktest</button>       
