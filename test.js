...
https://www.youtube.com/watch?v=X3bQzBhRMKQ&t=4213s&ab_channel=KongRuksiamOfficial
...
git reset (2.สำหรับย้อนคืน Version ที่ต้องการ)
usage:
--hard  ไฟล์ version ใหม่ ๆ จะถูกลบ จะเหลือ Version ที่คุณต้องการ และ ตัวที่เก่ากว่า จะเหลืออยู่
